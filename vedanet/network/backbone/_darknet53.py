...
class Darknet53(nn.Module):
    ...
    def forward(self, x):
        ...
        stage_4 = self.layers[0](x)                         # 256,52,52
        stage_5 = self.layers[1](stage_4)                   # 512,26,26
        stage_6 = self.layers[2](stage_5)                   # 1024,13,13

        head_body_1 =  self.layers[3](stage_6)                  # 512,13,13
        trans_1 = self.layers[4](head_body_1)               # 256,26,26

        concat_2 = torch.cat([trans_1, stage_5], 1)         # 768,26,26
        head_body_2 =  self.layers[5](concat_2)                 # 256,26,26
        trans_2 = self.layers[6](head_body_2)               # 128,52,52

        concat_3 = torch.cat([trans_2, stage_4], 1)         # 384,52,52
        head_body_3 =  self.layers[7](concat_3)                 # 128,52,52
